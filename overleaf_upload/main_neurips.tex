...
At the same time, TimesFM sits ${\approx}2.1\times$ below the per-dataset Transformer
($\ltcstep{=}4.64$ vs.\ $9.92$ on Electricity), which occupies the
memorisation regime.
...
\caption{\textbf{LTC step ($\ltcstep$) across datasets and model types.}
  ...
  \emph{Right}: on Electricity, TimesFM ($4.64$) sits ${\approx}2.1\times$ below
  the supervised Transformer ($9.92$) yet $19\%$ above the random encoder
...
trajectory richness to $\ltcstep{=}0.13$ on Electricity---a ${\approx}76\times$
reduction relative to the supervised Transformer on that benchmark---an encoding artefact
...
$\Delta$: TimesFM (pre) $=$ mean (pre$-$rnd) across datasets; TimesFM (rnd) $=$ mean (rnd$-$pre);
other rows $=$ mean (TimesFM pre $-$ row) across datasets.
...
TimesFM (rnd) & 3.90 & 3.52 & 3.70 & 2.55 & $-$1.21\\
$\Delta$      & $+$0.74 & $+$1.58 & $+$1.32 & $+$1.22 & $+$1.21\\
\midrule
LSTM   & 0.18 & 0.19 & 0.14 & 0.11 & $+$4.48\\
TCN    & 2.34 & 1.49 & 2.66 & 1.45 & $+$2.65\\
Trans. & 9.92 & 11.77 & 11.16 & 6.44 & $-$5.19\\
\midrule
\multicolumn{6}{l}{\textit{ETTh1 spikes \& Chronos:}}\\
OFA     & 1.00 & 1.68 & \textbf{17.69} & 1.62 & $-$0.87\\
UniTime & 3.30 & 2.68 & \textbf{28.90} & 3.86 & $-$5.05\\
TiRex   & 9.62 & 2.82 & \textbf{25.53} & 8.89 & $-$7.08\\
Moirai  & 9.97 & 2.91 & \textbf{26.66} & 9.64 & $-$7.66\\
Chronos-S & 0.13 & 0.19 & 0.21 & 0.15 & $+$4.46\\
\bottomrule
\end{tabular}
\end{minipage}%
\hfill
...
from pretraining.
TimesFM's manifold sits ${\approx}2.1\times$ below the supervised Transformer
($\ltcstep{=}4.64$ vs.\ $9.92$) yet $19\%$ above the random-weight encoder,
...
The supervised Transformer achieves $\ltcstep{=}9.92$ on Electricity---${\approx}2.1\times$
...
$\Delta$: TimesFM (pre) $=$ mean (pre$-$rnd); TimesFM (rnd) $=$ mean (rnd$-$pre);
other rows $=$ mean (TimesFM pre $-$ row) across the four datasets.}
\label{tab:ltc_ext}
\small
...
\midrule
TimesFM (pre)  & 4.64 & 5.10 & 5.02 & 3.77 & $+$1.21\\
TimesFM (rand) & 3.90 & 3.52 & 3.70 & 2.55 & $-$1.21\\
$\Delta$       & $+$0.74 & $+$1.58 & $+$1.32 & $+$1.22 & $+$1.21\\
\midrule
LSTM           & 0.18 & 0.19 & 0.14 & 0.11 & $+$4.48\\
TCN            & 2.34 & 1.49 & 2.66 & 1.45 & $+$2.65\\
Transformer    & 9.92 & 11.77 & 11.16 & 6.44 & $-$5.19\\
\midrule
\multicolumn{6}{l}{\textit{Additional TSFMs (no random-weight control)}}\\
LightGTS      & 1.59 & 0.64 & 8.86  & 1.63 & $+$1.45\\
OFA           & 1.00 & 1.68 & \textbf{17.69} & 1.62 & $-$0.87\\
Sundial       & 4.00 & 5.60 & 3.00  & 6.77 & $-$0.21\\
Time-MoE      & 0.77 & 1.40 & 4.09  & 1.77 & $+$2.62\\
UniTime       & 3.30 & 2.68 & \textbf{28.90} & 3.86 & $-$5.05\\
VisionTS      & 0.99 & 0.62 & 6.11  & 1.20 & $+$2.40\\
TiRex         & 9.62 & 2.82 & \textbf{25.53} & 8.89 & $-$7.08\\
MOMENT-Large  & 2.03 & 1.98 & 2.16  & 2.82 & $+$2.38\\
Moirai        & 9.97 & 2.91 & \textbf{26.66} & 9.64 & $-$7.66\\
Chronos-Small & 0.13 & 0.19 & 0.21  & 0.15 & $+$4.46\\
\bottomrule
\end{tabular}
\end{table}
