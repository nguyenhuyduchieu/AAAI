...
| 5 | `fig_lgf_pipeline` | §3 | Schematic flowchart | 🔲 Stub |
| 6 | `fig_ltc_intuition` | §3.2 | Path cartoon (2-panel) | 🔲 Stub |
| 7 | `fig_lcs_clusters` | §3.3 | PCA scatter (2-panel) | 🔲 Stub |
| 8 | `fig_pds_concept` | §3.4 | Density + proximity diagram | 🔲 Stub |
| 9 | `fig_css_probe` | §3.5 | Decision boundary scatter (3-panel) | 🔲 Stub |
| 10 | `fig_ood_summary` | §4.6 | 3×2 bar grid | 🔲 Stub |
| 11 | `fig_umap_pre_vs_rand` | Appendix | Side-by-side UMAP | 💡 Recommended |
| 12 | `fig_ltc_by_layer` | Appendix | Layer-wise line plot | 💡 Recommended |
| 13 | `fig_pds_scatter` | Appendix | Isolation vs. error scatter | 💡 Recommended |
| 14 | `fig_tsfm_taxonomy` | §2 | Taxonomy tree diagram | 💡 Recommended |
| 15 | `fig_css_gap_vs_params` | §5 | Scaling-law scatter | 💡 Recommended |
