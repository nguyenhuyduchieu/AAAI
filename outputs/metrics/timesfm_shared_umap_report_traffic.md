# Shared UMAP Control Report (traffic)

## LTC
- `ltc_pretrained`: 5.776064
- `ltc_random_reset`: 6.417862
- `delta_pre_minus_random`: -0.641798
...
## Artifacts
- Figure: `outputs/figures/figure_timesfm_umap_shared_traffic_pre_vs_random.png`
- Metrics CSV: `outputs/metrics/timesfm_shared_umap_metrics_traffic.csv`
- Coordinates CSV: `outputs/metrics/timesfm_shared_umap_coords_traffic.csv`